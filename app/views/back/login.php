...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="<?= PUBLIC_PATH; ?>back/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="<?= PUBLIC_PATH; ?>back/index2.html" class="h1"><b>Admin</b>LTE</a>
        </div>
        <div class="card-body">
            <p class="login-box-msg">Sign in to start your session</p>

            <form action="<?= PUBLIC_PATH; ?>admin/checkData" method="post">
...
<!-- AdminLTE App -->
<script src="<?= PUBLIC_PATH; ?>back/dist/js/adminlte.min.js"></script>
</body>
</html>
