            ...
            <form action="edit" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        <label>Name</label>
                        <input value="<?= $name; ?>" name="name" type="text" class="form-control" placeholder="Enter Content Name">
                    </div>

                    <div class="form-group">
                        <label>Main-Content</label>
                        <input value="<?= $mainContent; ?>" name="mainContent" type="text" class="form-control" placeholder="Enter Content Main Content">
                    </div>
